  ...
  tutorialData: {
    ...
    _default: [
      ...
      },
      {
        ...
        description: 'Learn how to view and manage laboratory tests.',
        steps: [
          {
            target: '[data-extension-id="laboratory-dashboard-link"]',
            title: 'Laboratory Section',
            content: 'Click here to navigate to the laboratory section.',
            disableBeacon: true,
            disableOverlayClose: true,
            spotlightClicks: true,
            hideCloseButton: true,
            ...
            hideFooter: true,
            data: {
              autoNextOn: '[data-extension-id="tests-ordered-tile-component"]',
            },
          },
          {
            target: '[data-extension-id="tests-ordered-tile-component"]',
            title: 'Tests Ordered',
            content: 'This section displays all the tests ordered for the patient.',
            disableBeacon: true,
            disableOverlayClose: true,
            spotlightClicks: true,
            hideBackButton: true,
          ...
          {
            target: '[data-extension-id="worklist-tile-component"]',
            title: 'Worklist',
            content: 'This section displays all the tests that need to be processed.',
            disableBeacon: true,
            disableOverlayClose: true,
            spotlightClicks: true,
          },
          {
            target: '[data-extension-id="completed-tile-component"]',
            title: 'Completed Tests',
            content: 'This section displays all the tests that have been processed.',
            disableBeacon: true,
            disableOverlayClose: true,
            spotlightClicks: true,
          },
          {
            target: '[data-extension-id="all-lab-requests-table"]',
            title: 'Lab Requests',
            content: 'This table displays all the lab requests for the patients.',
            disableBeacon: true,
            disableOverlayClose: true,
          },
        ],
